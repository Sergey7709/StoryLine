        ...
        <Grid.Col span={12} style={{ height: "20rem" }}>
          ...
          >
            <Text size="sm">
              ...
              приключений юного волшебника, которое смогло захватить меня с
              первых страниц. Я был увлечен уникальной атмосферой магического
              мира, которую так мастерски создает Джоан Роулинг, и не мог
              оторваться от книги до последней страницы. Персонажи, включая
              Гарри, Рона и Гермиону, были так живо и убедительно описаны, что я
              чувствовал, будто сам нахожусь в Хогвартсе и учусь там вместе с
              ними. "Тайная комната" - это остроумный и захватывающий роман,
              который порадует любого поклонника жанра фэнтези. Я рекомендую его
              всем, кто ищет захватывающую и захватывающую историю, полную
              магии, приключений и дружбы.
            </Text>
          </Spoiler>
        </Grid.Col>
      </Grid>
