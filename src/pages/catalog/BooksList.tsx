...
export const books: ItemProps[] = [
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/710/orig/i710218.jpg?cu=20201230101528',
    description:
  ...
  },
  {
    inStock: true,
    title: 'Война и мир',
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/669/orig/i669023.jpg?cu=20190902123514',
    description:
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/543/w259/i543138.jpg?cu=20180101000000',
    description: 'Роман Рэя Брэдбери о жизни в будущем, в котором книги запрещены и сжигаются.',
    category: 'Фантастика',
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/564/w259/i564815.jpg?cu=20180101000000',
    description:
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/454/w259/i454685.jpg?cu=20180101000000',
    description: 'Первая книга в серии о Гарри Поттере, автором которой является Джоан Роулинг.',
    category: 'Фэнтези',
    publisher: 'Росмэн',
    discount: 10,
    pagesCount: 256,
  ...
  },
  {
    ...
    description: 'Вторая книга в серии о Гарри Поттере, автором которой является Джоан Роулинг.',
    category: 'Фэнтези',
    publisher: 'Росмэн',
    discount: 15,
    pagesCount: 384,
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/466/w259/i466300.jpg?cu=20180101000000',
    description: 'Третья книга в серии о Гарри Поттере, автором которой является Джоан Роулинг.',
    category: 'Фэнтези',
    publisher: 'Росмэн',
    discount: 0,
    pagesCount: 480,
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/355/orig/i355030.jpg?cu=20180101000000',
    description:
  ...
  },
  {
    inStock: true,
    title: 'Анна Каренина',
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/410/orig/i410282.jpg?cu=20180101000000',
    description: 'Роман Льва Толстого о жизни высшего общества России в конце 19 века.',
    category: 'Классика',
    publisher: 'Эксмо',
    discount: 0,
    pagesCount: 864,
  ...
  },
  {
    ...
    itemImageUrl: 'https://www.moscowbooks.ru/image/book/768/w259/i768813.jpg?cu=20221207150502',
    description: 'Роман Льюиса Кэрролла о девочке Алисе, которая попадает в страну чудес.',
    ...
    <Grid className={classes.grid} align="center">
      {data &&
        data.items.map((book, index) => (
          ...
          <Grid.Col xs={6} sm={4} md={4} lg={3} xl={2} className={classes.gridCol} key={index}>
            <Card
              key={book.id}
